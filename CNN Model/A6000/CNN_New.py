...
torch.save(model.state_dict(), "cnn_instrument_recognizer_100epoch_64batchsize_0.001lr.pth")
print("Model saved as cnn_instrument_recognizer_100epoch_64batchsize_0.001lr.pth")
